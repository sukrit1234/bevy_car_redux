use crate::car::{joint::build_joint, spawn_wheel, CarSpec, WheelSpec};
use crate::collision::{CAR_TRAINING_GROUP, STATIC_GROUP};
use bevy::prelude::*;
...
pub fn spawn_car(
    ...
    if player {
        cmd.entity(car_id).insert(PlayerControlled);
    }
    car_id
}
